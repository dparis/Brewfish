...
Gem::Specification.new do |s|
  ...
  s.homepage    = ""
  s.summary     = %q{Tools for developing roguelikes}
  s.description = %q{A collection of tools to assist in development of roguelikes or other ascii-based console games}
